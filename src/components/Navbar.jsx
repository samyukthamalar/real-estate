  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
        {/* Logo */}
        <img src={assets.logo} alt="Real Estate Logo" />
        ...
        <a
          href="#Contact"
          className="hidden md:block bg-white text-gray-800 px-8 py-2 rounded-full hover:bg-gray-200 transition duration-300"
        >
          Sign Up
        </a>
